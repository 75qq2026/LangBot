const enUS = {
  ...
  customers: {
    title: 'Customers',
    description: 'Collect and manage customer profiles from conversations',
    loadListError: 'Failed to load the customer list',
    loadDetailError: 'Failed to load customer details',
    empty: 'No matching customers found',
    emptyTitle: 'No customers yet',
    emptyDescription:
      'When the bot starts talking to users, structured customer profiles and conversation history will appear here automatically.',
    searchPlaceholder: 'Search by name, phone, need, or channel',
    totalCustomers: 'Customers',
    listDescription: '{{count}} customers in total',
    latestActivity: 'Latest activity',
    export: 'Export Excel',
    exporting: 'Exporting...',
    exportSuccess: 'Customer data exported successfully',
    exportError: 'Failed to export customer data',
    ...
    anonymousSource: 'Unknown source',
    tags: 'Tags',
    latestSummary: 'Latest summary',
    latestNeed: 'Latest need',
    fields: {
      name: 'Name',
      phone: 'Phone',
      email: 'Email',
