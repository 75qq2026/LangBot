const enUS = {
  ...
  customers: {
    title: 'Customers',
    description:
      'Review structured customer profiles and conversation timelines collected from pipeline chats',
    selectFromSidebar: 'Select a customer from the sidebar',
    searchPlaceholder: 'Search by name, phone, company, requirement, or user',
    searchButton: 'Search',
    clearSearch: 'Clear',
    refresh: 'Refresh',
    export: 'Export Excel',
    exporting: 'Exporting...',
    loadListError: 'Failed to load customer list',
    loadDetailError: 'Failed to load customer detail',
    exportError: 'Failed to export customer list',
    noResults: 'No customers found',
    noResultsDescription:
      'Customer profiles will appear here after pipeline conversations are processed.',
    notFound: 'Customer not found',
    backToList: 'Back to customer list',
    profileTitle: 'Customer Profile',
    profileDescription: 'Structured information extracted from conversations.',
    timelineTitle: 'Conversation Timeline',
    timelineDescription: 'Chronological record of customer and agent messages.',
    emptyTimeline: 'No conversation timeline available yet.',
    table: {
      customer: 'Customer',
      phone: 'Phone',
