const zhHans = {
  ...
  customers: {
    title: '客户资料',
    description: '查看客户档案、需求摘要与对话时间线。',
    loadListError: '加载客户列表失败',
    loadDetailError: '加载客户详情失败',
    emptyList: '暂无客户资料',
    emptyDetailHint: '请选择左侧客户查看详情。',
    emptyTimeline: '暂无对话记录',
    noSummary: '暂无需求摘要',
    listTitle: '客户列表',
    detailTitle: '客户详情',
    timelineTitle: '对话时间线',
    selectCustomer: '请选择一个客户查看详情',
    loading: '正在加载客户数据...',
    empty: '暂无客户资料',
    emptyDescription:
      '当机器人与客户开始对话后，系统会自动沉淀客户档案与对话记录。',
    loadError: '加载客户数据失败',
    export: '导出 Excel',
    exporting: '正在导出...',
    retry: '重试',
    allPipelines: '全部流水线',
    searchPlaceholder: '搜索姓名、电话、需求、备注...',
    listDescription: '共 {{count}} 位客户',
    timelineDescription: '按时间顺序查看与客户的完整对话。',
    totalCustomers: '客户总数',
    withPhone: '已采集电话',
    withRequirements: '已记录需求',
    recentConversations: '近 7 天对话',
    lastActivity: '最近互动',
    latestIntent: '最新需求',
    unknownName: '未命名客户',
    unknownPhone: '未登记',
    noRequirements: '暂无需求摘要',
    noNotes: '暂无备注',
    ...
    detail: {
      profile: '客户档案',
      timeline: '对话时间线',
      conversationStats: '会话统计',
      contactInfo: '联系方式',
      sourceInfo: '来源信息',
      summary: '需求摘要',
      notes: '跟进备注',
      extractedFields: '结构化字段',
      basicFields: {
        name: '姓名',
        phone: '电话',
        email: '邮箱',
      ...
      metaFields: {
        ...
        firstSeen: '首次互动',
        lastSeen: '最近互动',
        conversationCount: '对话条数',
      },
      role: {
        user: '客户',
        assistant: '机器人',
      },
      emptyTimeline: '该客户还没有可展示的对话时间线。',
    },
    columns: {
      name: '客户',
      phone: '电话',
