const zhHans = {
  ...
  customers: {
    title: '客户资料',
    description: '查看由对话自动沉淀的客户档案与沟通时间线',
    selectFromSidebar: '从侧边栏选择一个客户，或在下方列表中查看',
    listTitle: '客户列表',
    listDescription: '系统会根据 Pipeline 对话自动更新客户信息与需求摘要',
    searchPlaceholder: '搜索姓名、电话、公司、需求、用户 ID',
    ...
    export: '导出 Excel',
    exporting: '导出中...',
    exportError: '导出客户资料失败',
    refresh: '刷新',
    notFound: '客户不存在或已被删除',
    backToList: '返回客户列表',
    profileTitle: '客户档案',
    profileDescription: '结构化客户资料会随着对话持续补充',
    timelineTitle: '对话时间线',
    timelineDescription: '展示该客户在当前会话中的消息往来',
    emptyTimeline: '暂无对话记录',
    lastContactAt: '最近联系时间',
    status: {
      new: '待完善',
      partial: '部分完善',
      complete: '完整',
